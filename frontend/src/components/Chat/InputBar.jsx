            ...
            <div className="relative mx-auto w-full max-w-[72rem] space-y-3">
                                ...
                                >
                                    {item.type === "image" ? (
                                        ...
                                        <div className="flex flex-col items-center rounded-[22px] border border-border/70 bg-surface px-4 py-4">
                                            ...
                                            <p className="mt-3 w-full truncate text-center text-[0.625rem] font-bold text-text" title={item.file.name}>
                                                {item.file.name}
                                            </p>
                                            <p className="mt-1 text-[0.5625rem] text-text-dim">{item.preview.size} MB</p>
                                        </div>
                                    )}
                ...
                <div className="flex items-end gap-3 rounded-[28px] border border-border/70 bg-surface px-4 py-3 shadow-[0_18px_40px_rgba(0,0,0,0.22)] focus-within:border-accent/50 focus-within:bg-surface-strong">
                    ...
                    <textarea
                        ...
                        disabled={isLoading}
                        className="min-h-[24px] flex-1 resize-none border-none bg-transparent px-2 text-[0.875rem] leading-relaxed text-text placeholder:text-text-dim outline-none"
                    ...
                    <button
                        ...
                        onClick={handleSend}
                        disabled={!canSend}
                        className={`mb-0.5 inline-flex flex-shrink-0 items-center gap-2 rounded-2xl px-5 py-2.5 text-[0.6875rem] font-black uppercase tracking-[0.24em] transition-colors ${
                            canSend
                ...
                <div className="flex items-center justify-between gap-3 px-1">
                    <p className="text-[0.5625rem] font-black uppercase tracking-[0.24em] text-text-dim">
                        Architect AI can make mistakes. Verify important information.
                    </p>
                    {searchMode && (
                        <p className="flex items-center gap-1 text-[0.5625rem] font-black uppercase tracking-[0.18em] text-success">
                            <Globe size={10} />
                            Web search active
                        </p>
                    )}
                    {selectedFiles.length > 0 && (
                        <p className="text-[0.5625rem] font-black uppercase tracking-[0.18em] text-accent">
