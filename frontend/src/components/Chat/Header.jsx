            ...
            <div className="flex items-center justify-between gap-3 lg:grid lg:grid-cols-[max-content_minmax(0,1fr)_max-content] lg:gap-6">
                ...
                <div className="flex items-center gap-2 sm:gap-3 lg:justify-self-end">
                    ...
                    <div className="relative">
                        ...
                        >
                            <div className="flex h-9 w-9 items-center justify-center rounded-2xl border border-border/70 bg-background-elevated text-[0.8125rem] font-black uppercase text-text">
                                {userInitials}
                            </div>
                            <div className="min-w-0 flex-1 text-left">
                                <p className="truncate text-[0.625rem] font-black uppercase tracking-[0.24em] text-text">
                                    {userName.toUpperCase()}
                                </p>
                                <p className="mt-1 text-[0.5625rem] font-black uppercase tracking-[0.26em] text-accent">
                                    Pro
                                </p>
                            </div>
