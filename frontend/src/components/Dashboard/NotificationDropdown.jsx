                ...
                <>
                    ...
                    >
                                    ...
                                    >
                                        ...
                                        <div className="min-w-0 flex-1">
                                            <div className="flex items-start justify-between gap-2">
                                                ...
                                                <span className="shrink-0 text-[0.625rem] text-text-dim">
                                                    {notif.time}
                                                </span>
                                            </div>
                        ...
                        <div className="border-t border-border/70 bg-surface px-4 py-3">
                            <button className="flex w-full items-center justify-center gap-2 text-[0.625rem] font-black uppercase tracking-[0.24em] text-muted transition-colors hover:text-text">
