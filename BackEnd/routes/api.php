...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // System Settings Routes (for AI provider keys)
    Route::get('/system/settings', 'App\Http\Controllers\SystemSettingController@index');
    Route::post('/system/settings', 'App\Http\Controllers\SystemSettingController@update');
