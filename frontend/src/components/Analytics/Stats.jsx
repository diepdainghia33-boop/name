        ...
        <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
            {statCards.map((card, index) => (
                ...
                >
                    ...
                    <p className="relative z-10 mb-2 text-[0.625rem] font-black uppercase tracking-[0.24em] text-muted">
                        {card.title}
                    </p>
                    ...
                    {card.trend && (
                        <div className="relative z-10 mt-3 flex items-center gap-2">
                            ...
                            <span className={`text-[0.625rem] font-black uppercase tracking-[0.24em] ${card.trendUp ? "text-success" : "text-danger"}`}>
