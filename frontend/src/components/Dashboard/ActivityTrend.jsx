    ...
    return (
        <div className="group relative overflow-hidden rounded-[28px] border border-border/70 bg-surface p-5 shadow-[0_16px_40px_rgba(0,0,0,0.24)]">
            <div className="mb-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1 text-[0.625rem] font-black uppercase tracking-[0.24em] text-text-dim">
                    <Clock size={10} />
                    7 cycles
                </div>
            </div>
            ...
            <div className="mt-2 flex justify-between">
                {labels.map((label, i) => (
                    <span key={i} className="text-[0.5rem] font-black uppercase tracking-tighter text-text-dim">
                        {label}
                    </span>
                ))}
            </div>
