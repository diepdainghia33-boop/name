            ...
            <div className="relative flex flex-col gap-8 p-6 lg:flex-row lg:p-8">
                <div className="flex flex-row justify-between gap-6 lg:flex-col lg:justify-center lg:border-r lg:border-border/70 lg:pr-10">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 text-[0.625rem] font-black uppercase tracking-[0.2em] text-accent">
                            <Zap size={10} /> Total
                        </div>
                        <p className="text-3xl font-black text-text">{total}</p>
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 text-[0.625rem] font-black uppercase tracking-[0.2em] text-success">
                            <TrendingUp size={10} /> Peak
                        </div>
                        <p className="text-3xl font-black text-text">{peak}</p>
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 text-[0.625rem] font-black uppercase tracking-[0.2em] text-text-dim">
