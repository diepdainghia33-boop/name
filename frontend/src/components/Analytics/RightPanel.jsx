...
export default function RightPanel() {
    const [intents, setIntents] = useState([
        { name: "Invoice Analysis", value: 35, color: "hsl(var(--accent))" },
        { name: "Architectural Consulting", value: 25, color: "#22c55e" },
        { name: "General Chat", value: 40, color: "hsl(var(--muted-foreground))" },
    ]);
                ...
                <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="rounded-2xl border border-border/70 bg-surface p-3">
                            <p className="text-[0.625rem] uppercase text-text-dim">Uptime</p>
                            <p className="text-lg font-black text-success">
                                {metrics.health === null || metrics.health === undefined ? "--" : `${metrics.health}%`}
                            </p>
                        </div>
                        <div className="rounded-2xl border border-border/70 bg-surface p-3">
                            <p className="text-[0.625rem] uppercase text-text-dim">Latency</p>
