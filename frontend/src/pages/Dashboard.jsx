    ...
    return (
        <div className="app-shell flex min-h-screen bg-background text-text">
            ...
            <main className="ml-72 flex-1">
                <div className="pointer-events-none fixed inset-0 bg-[radial-gradient(circle_at_top_right,color-mix(in_oklch,hsl(var(--accent))_10%,transparent),transparent_24%),radial-gradient(circle_at_20%_20%,color-mix(in_oklch,#22c55e_8%,transparent),transparent_22%),linear-gradient(180deg,hsl(var(--background))_0%,oklch(var(--color-background-elevated))_45%,hsl(var(--background))_100%)]" />
                                    ...
                                    <div className="grid max-h-[calc(100vh-2rem)] overflow-auto lg:grid-cols-[1.2fr_0.8fr]">
                                        <div className="relative p-6 sm:p-8 lg:p-12">
                                            <div className="flex items-start justify-between gap-4">
                                                <div className="inline-flex items-center gap-2 rounded-full border border-accent/20 bg-accent/10 px-4 py-2 text-[0.625rem] font-black uppercase tracking-[0.35em] text-accent">
                                                    <ShieldCheck size={14} />
                                            ...
                                            <div className="mt-8 max-w-3xl">
                                                <p className="text-[0.625rem] font-black uppercase tracking-[0.45em] text-accent/80">
                                                ...
                                                {welcomeHighlights.map(({ label, value, icon: Icon }) => (
                                                    ...
                                                    >
                                                        <div className="mb-6 flex items-center justify-between">
                                                            <span className="text-[0.625rem] font-black uppercase tracking-[0.3em] text-text-dim">
                                                                {label}
                                                            </span>
                                            ...
                                            <div className="relative z-10 flex h-full flex-col justify-between gap-8">
                                                <div className="space-y-6">
                                                    <div className="flex items-center justify-between">
                                                        <p className="text-[0.625rem] font-black uppercase tracking-[0.35em] text-text-dim">
                                                            Command Center
                                                        </p>
                                                        <span className="inline-flex items-center gap-2 rounded-full border border-success/20 bg-success/10 px-3 py-1 text-[0.5625rem] font-black uppercase tracking-[0.25em] text-success">
                                                ...
                                                <div className="grid gap-3 sm:grid-cols-2">
                                                    <div className="rounded-[22px] border border-border/70 bg-surface p-4">
                                                        <p className="text-[0.625rem] font-black uppercase tracking-[0.3em] text-text-dim">
                                                            Session
                                                        </p>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="overflow-hidden rounded-[32px] border border-border/70 bg-background-elevated shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
                                <div className="grid gap-8 p-6 lg:grid-cols-[1fr_320px] lg:p-8">
                                    <div className="space-y-6">
                                        <div className="inline-flex items-center gap-2 rounded-full border border-accent/20 bg-accent/10 px-3 py-1 text-[0.625rem] font-black uppercase tracking-[0.3em] text-accent">
                                            Live Intelligence
                                        </div>
                                        ...
                                        <div className="grid gap-4 md:grid-cols-3">
                                            {overviewStats.map(({ label, value, icon: Icon, tone }) => (
                                                <div key={label} className={`rounded-2xl border bg-gradient-to-br p-4 ${tone}`}>
                                                    <div className="mb-6 flex items-center justify-between">
                                                        <span className="text-[0.625rem] font-black uppercase tracking-[0.2em] text-white/50">{label}</span>
                                                        <Icon size={16} />
                                                    </div>
                                    ...
                                    <div className="flex h-full flex-col justify-between rounded-[28px] border border-border/70 bg-surface p-6">
                                        <div>
                                            <p className="text-[0.625rem] font-black uppercase tracking-[0.32em] text-text-dim">Last Sync</p>
                                            <p className="mt-3 text-lg font-bold text-white">
                                                {lastSyncTime.toLocaleTimeString("vi-VN", { hour: "2-digit", minute: "2-digit", second: "2-digit" })}
                                            </p>
                                            <p className="mt-1 text-[0.625rem] text-text-dim uppercase tracking-widest font-black">
                            ...
                            {isLoading ? (
                                    ...
                                    <p className="font-black text-[0.625rem] uppercase tracking-[0.3em]">Synching Neural Data...</p>
                                </div>
                            ) : (
                                <>
                        ...
                        <aside className="space-y-8">
                            <div className="sticky top-24 space-y-8">
                                ...
                                <div className="space-y-4">
                                    <div className="px-2">
                                        <h3 className="text-[0.625rem] font-black uppercase tracking-[0.4em] text-text-dim">Operational Log</h3>
                                    </div>
