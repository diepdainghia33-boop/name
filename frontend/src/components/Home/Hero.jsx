                        ...
                        {highlights.map(({ label, value, icon: Icon }) => (
                            <div key={label} className="app-panel rounded-[24px] p-4">
                                <div className="mb-6 flex items-center justify-between">
                                    <span className="text-[0.625rem] font-black uppercase tracking-[0.32em] text-muted">
                                        {label}
                                    </span>
                    ...
                    <div className="app-panel-strong relative min-h-[520px] overflow-hidden rounded-[36px] p-6 sm:p-8">
                        ...
                        <div className="relative grid h-full gap-4">
                            <div className="flex items-center justify-between gap-4">
                                <div>
                                    <p className="text-[0.625rem] font-black uppercase tracking-[0.35em] text-muted">
                                        Session overview
                                    </p>
                                ...
                                >
                                    ...
                                    <div className="mt-5 space-y-3">
                                        <div className="rounded-[22px] border border-border/70 bg-surface px-4 py-3">
                                            <div className="flex items-center gap-2 text-[0.625rem] font-black uppercase tracking-[0.28em] text-muted">
