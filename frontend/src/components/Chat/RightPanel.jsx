...
const SectionLabel = memo(function SectionLabel({ label }) {
    return (
        <div className="flex items-center gap-2 mb-3 pt-2 first:pt-0">
            ...
            <span className="text-[0.5625rem] font-black uppercase tracking-widest text-text-dim">{label}</span>
            <div className="h-px flex-1 bg-border/70" />
        </div>
    );
});
                ...
                <div className="flex items-center justify-between border-b border-border/70 bg-background-elevated p-4 lg:hidden">
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            ...
                            <p className="text-[0.5625rem] text-text-dim">Codex v2.4</p>
                        </div>
                    </div>
                ...
                <div className="mb-5 border-b border-border/70 pb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                            ...
                            <p className="text-[0.5625rem] text-text-dim">v2.4.0 • Active</p>
                        </div>
                        <ProjectCodexButton />
                    </div>
                </div>
            ...
            <div className={`flex-1 space-y-4 overflow-y-auto pr-1 scrollbar-hide ${isMobile ? "px-0" : ""}`}>
                <div className="relative group">
                    ...
                    <input
                        ...
                        className={`app-input w-full pl-10 pr-10 py-2.5 text-[0.75rem] font-medium ${isMobile ? "text-sm" : ""}`}
                    />
                    {searchQuery && (
                        <motion.button
                ...
                {(filteredConversations.pinned.length > 0 || Object.values(groupedUnpinned).some((group) => group.length > 0)) && (
                    <div className="flex items-center justify-between pt-1">
                        <h3 className="text-[0.625rem] font-black uppercase tracking-[0.15em] text-text-dim">
                            Conversations
                        </h3>
                        <span className="text-[0.5625rem] font-medium text-text-dim">{conversations.length} total</span>
                    </div>
                )}
                ...
                {filteredConversations.pinned.length > 0 && (
                    <div className="space-y-2">
                        <div className="mb-2 flex items-center gap-2">
                            ...
                            <p className="text-[0.5625rem] font-black uppercase tracking-[0.2em] text-warning/70">
                                Pinned
                            </p>
                        </div>
                        <AnimatePresence>
            ...
            {!isMobile && (
                <div className="mt-auto pt-4 border-t border-border/70">
                    <div className="space-y-3 rounded-2xl border border-border/70 bg-surface p-4">
                        <p className="mb-2 text-[0.625rem] font-black uppercase tracking-wider text-text-dim">
                            Session Stats
                        </p>
                        <div className="flex items-center justify-between">
                            <span className="text-[0.625rem] text-text-dim">Total Chats</span>
                            <span className="text-[0.6875rem] font-black text-text">{conversations.length}</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-[0.625rem] text-text-dim">Today</span>
                            <span className="text-[0.6875rem] font-black text-accent">{activeToday}</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-[0.625rem] text-text-dim">Pinned</span>
                            <span className="text-[0.6875rem] font-black text-warning">{filteredConversations.pinned.length}</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-[0.625rem] text-text-dim">Messages</span>
                            <span className="text-[0.6875rem] font-black text-text">{totalMsgs}</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-[0.625rem] text-text-dim">Tokens</span>
                            <span className="text-[0.6875rem] font-black text-accent">{totalTokens.toLocaleString()}</span>
                        </div>
                        ...
                        {archivedCount > 0 && (
                            <button
                                ...
                                className="mt-2 flex w-full items-center justify-center gap-2 rounded-xl border border-border/70 px-3 py-2 text-[0.625rem] font-medium text-text-muted transition-all hover:border-border-strong hover:bg-surface-strong hover:text-text"
                            >
                    ...
                    >
                        <div className="p-1.5">
                            ...
                            <button
                                type="button"
                                onClick={() => {
                                    onDuplicateConversation?.(contextMenu.id);
                                    closeContextMenu();
                                }}
                                className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-xs text-text-muted transition hover:bg-surface-strong hover:text-text"
                            >
