    ...
    return (
        <aside className="flex h-full w-80 shrink-0 flex-col border-l border-border/70 bg-background/95 backdrop-blur-xl">
            <div className="border-b border-border/70 p-6">
                <h3 className="mb-6 text-[0.625rem] font-black uppercase tracking-[0.3em] text-muted">
                    System status
                </h3>
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-[0.625rem] font-black uppercase tracking-[0.24em] text-success">Operational</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-[0.625rem] font-black uppercase tracking-[0.24em] text-accent">Synced</span>
                    </div>

                    <div className="rounded-[22px] border border-border/70 bg-surface p-3">
                        <div className="mb-2 flex items-center justify-between">
                            <span className="text-[0.625rem] font-black uppercase tracking-[0.24em] text-muted">CPU Load</span>
                            <span className="text-[0.625rem] font-black uppercase tracking-[0.24em] text-text">42%</span>
                        </div>
            ...
            <div className="flex flex-1 flex-col overflow-hidden p-6">
                        ...
                        logs.map((log, i) => {
                            ...
                            return (
                                <div key={i} className="relative rounded-[20px] border border-border/70 bg-surface px-4 py-3">
                                    ...
                                    <p className="text-[0.6875rem] font-bold text-text">
                                    ...
                                    <p className="mt-1 text-[0.625rem] leading-relaxed text-text-muted">{log}</p>
                                    <p className="mt-2 text-[0.5625rem] font-black uppercase tracking-[0.24em] text-text-dim">
                ...
                <button
                    ...
                    className="mt-6 rounded-2xl border border-border/70 bg-background px-4 py-2 text-[0.625rem] font-black uppercase tracking-[0.24em] text-muted transition-colors hover:border-accent/40 hover:text-text"
                >
                    View full archive
                </button>
            </div>
            ...
            <div className="border-t border-border/70 bg-surface p-6">
                <div className="flex items-center gap-3 text-text-muted opacity-60">
                    ...
                    <p className="text-[0.5625rem] font-black uppercase leading-tight tracking-[0.24em]">
