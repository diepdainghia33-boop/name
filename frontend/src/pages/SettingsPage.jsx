                            ...
                            <section className="space-y-4">
                                ...
                                >
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                        ...
                                        >
                                            <span className="text-[0.625rem] font-display font-bold text-text-muted">STANDARD</span>
                                            ...
                                            <span className="text-[0.625rem] font-display font-bold text-accent">ULTRA</span>
                                        </motion.div>
                                    </div>
                                        ...
                                        >
                                            <div className="flex justify-between items-center">
                                                ...
                                                <motion.span
                                                    ...
                                                    initial={{ scale: 1.2 }}
                                                    animate={{ scale: 1 }}
                                                    className="text-[0.625rem] font-display text-accent font-bold"
                                                >
                                                    {sliders.creativity}%
                                                </motion.span>
                                            </div>
                            ...
                            <section className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    >
                                        <div className="flex items-center gap-4 mb-4">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex justify-between items-center">
                                                    ...
                                                    <span className="text-[0.625rem] font-display text-accent font-bold">{sliders.contextLength}%</span>
                                                </div>
                                        ...
                                        <div className="flex justify-between text-[0.5rem] text-text-muted mt-2">
                                            <span>Compact</span>
                                            <span>Extended</span>
                                        </div>
                                    </motion.div>
