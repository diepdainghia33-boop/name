                ...
                <div className="mt-12 grid gap-6 lg:grid-cols-[1.3fr_0.7fr]">
                    ...
                    >
                        <div className="flex items-center justify-between gap-4 border-b border-border/60 pb-5">
                            ...
                            <div className="hidden rounded-full border border-accent/20 bg-accent/10 px-4 py-2 text-[0.625rem] font-black uppercase tracking-[0.3em] text-accent sm:inline-flex">
                                Stable
                            </div>
                        </div>
                            ...
                            {features.map(({ icon: Icon, eyebrow, title, desc }) => (
                                <div key={title} className="app-panel rounded-[28px] p-5">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-[0.625rem] font-black uppercase tracking-[0.28em] text-muted">
                                                {eyebrow}
                                            </p>
