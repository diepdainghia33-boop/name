    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 mb-6 flex items-center justify-between">
                <h3 className="text-[0.625rem] font-black uppercase tracking-[0.3em] text-muted">
                    System Pulse
                </h3>
                <span className="flex items-center gap-2">
                    {isHealthy !== null && <span className={`h-2 w-2 rounded-full ${statusTone} animate-pulse`} />}
                    <span className="text-[0.625rem] font-black uppercase tracking-[0.24em] text-muted">
                        {statusText}
                    </span>
                </span>
            </div>
            ...
            <div className="relative z-10 space-y-4">
                <div className="flex items-center justify-between rounded-[22px] border border-border/70 bg-background px-4 py-3 transition-colors hover:bg-surface-strong">
                    ...
                    <span className={`text-[0.5625rem] font-black uppercase tracking-[0.24em] ${isHealthy === null ? "text-text-dim" : isHealthy ? "text-success" : "text-danger"}`}>
                        {statusText}
                    </span>
                </div>
                ...
                <div className="flex items-center justify-between rounded-[22px] border border-border/70 bg-background px-4 py-3 transition-colors hover:bg-surface-strong">
                    ...
                    <span className="text-[0.5625rem] font-black uppercase tracking-[0.24em] text-accent">Synced</span>
                </div>
