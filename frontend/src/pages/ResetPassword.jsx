    ...
    return (
        <div className="min-h-screen overflow-hidden bg-background text-text">
                ...
                <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 sm:px-8">
                    <Link to="/" className="flex items-center gap-3">
                        ...
                        <div className="leading-tight">
                            ...
                            <p className="text-[0.625rem] font-black uppercase tracking-[0.32em] text-muted">
                                Reset password
                            </p>
                        </div>
                    </Link>
            ...
            <main className="relative z-10 mx-auto flex min-h-[calc(100vh-5rem)] max-w-3xl items-center px-6 py-10 sm:px-8">
                ...
                >
                    <div className="inline-flex items-center gap-2 rounded-full border border-border/70 bg-surface px-4 py-2 text-[0.625rem] font-black uppercase tracking-[0.28em] text-muted">
                    ...
                    {success ? (
                        ...
                        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
                            <label className="block">
                                <span className="mb-2 block text-[0.625rem] font-black uppercase tracking-[0.28em] text-muted">
                                    Email
                                </span>
                                <input
                                    type="email"
